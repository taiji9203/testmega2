...
<script type="text/javascript" async="" src="resources/js/analytics.js.다운로드"></script><script async="" src="resources/js/js"></script>
...
<script src="resources/js/megabox.common.min.js"></script>
 <script src="resources/js/megabox.netfunnel.min.js"></script><script src="resources/main_files/ts.wseq"></script>
<script src="resources/js/persona.js" async=""></script>
<script src="resources/js/ui.common.js"></script>
<script src="resources/js/m-ny8Ge9GlYZJI4cgMhnHRaYB3JpsfRgMZ-aSWeaR4SEAM4qWzAZAbZEZkUwWnZPUVNfQ01sOTEtVU9TeHFRAstB2JUHayDnTwPLQdiVB2sg508.js"></script>
<script src="resources/js/front.js"></script>
<script src="resources/js/bc4af2fa1e" async="" type="text/javascript"></script>
<script src="resources/js/bc4af2fa1e(1)" async="" type="text/javascript"></script>
</head>
